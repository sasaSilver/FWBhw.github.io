        ...
        <ul className="projects-list">
          <li>
            <p>
              ...
              <u>
                <a href="https://github.com/sasaSilver/BookingBot">→</a>
              </u>
            </p>
            <p>
              While working on this project, I am learning{" "}
              <em className="blue">aiogram</em> and
              <em className="blue"> SQLite</em> for creating simple and cool{" "}
              <em className="blue"> telegram bots</em>!
            </p>
          </li>
